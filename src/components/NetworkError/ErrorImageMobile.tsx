...
const SvgComponent = (props: React.SVGProps<SVGSVGElement>) => (
  <svg width={265} height={234} {...props}>
    ...
    <g transform="translate(15 1)" fill="none" fillRule="evenodd">
      <g filter="url(#a)" transform="translate(0 24)">
        <ellipse
          stroke="#FFF"
          strokeWidth={15}
          fill="#C5E8EF"
      ...
      <g stroke="#45413C" strokeLinejoin="round">
        <path
          d="M45.003 16.948c0-3.285 2.653-5.948 5.924-5.948h65.15c3.27 0 5.923 2.663 5.923 5.948v46.093c0 3.285-2.652 5.948-5.924 5.948h-20.73v6.574a3.442 3.442 0 0 1-2.112 3.175 3.411 3.411 0 0 1-3.73-.746l-8.966-9.003H50.924c-3.272 0-5.924-2.663-5.924-5.948V16.948h.003z"
          fill="#FFF"
          fillRule="nonzero"
        />
        <path d="M59 31h33M59 42h45M59 52h45" strokeLinecap="round" />
      </g>
      ...
      <g transform="translate(113 70)">
        <path
          d="M44.638 98.288c-1.896 3.46-6.235 4.73-9.69 2.828L3.707 83.946C.25 82.048-1.014 77.7.881 74.24L39.494 3.712A7.133 7.133 0 0 1 49.183.88l31.243 17.17a7.158 7.158 0 0 1 2.825 9.707l-38.613 70.53z"
          stroke="#45413C"
          fill="#FFF"
          fillRule="nonzero"
          strokeLinecap="round"
        ...
        <path
          fill="#00B8F0"
          fillRule="nonzero"
          d="M4.264 68.055L36.13 9.957l43.736 23.988-31.865 58.098z"
        />
        <path
          fill="#4ACFFF"
          fillRule="nonzero"
          d="M7.445 61.051l70.73-28.374-42.3-22.998z"
        />
        <path
          stroke="#45413C"
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M4.264 68.055L36.13 9.957l43.736 23.988-31.865 58.098zM67.752 19.358l1.644.9M52.861 11.168l10.424 5.956"
        />
        <circle
          stroke="#45413C"
          fill="#FFF"
